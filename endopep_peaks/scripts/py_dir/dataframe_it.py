...
df_final_1 = df_final.reset_index(drop=True).style.applymap(highlight_1, subset=pd.IndexSlice[:, ['LC_A','HC_A','Intact_A']]) \
.applymap(highlight_2, subset=pd.IndexSlice[:, ['LC_B', 'HC_B','Intact_B']]) \
.applymap(highlight_3, subset=pd.IndexSlice[:, ['LC_E','HC_E','Intact_E']]) \
.applymap(highlight_4, subset=pd.IndexSlice[:, ['LC_F','HC_F','LC_F5','HC_F5','Intact_F']]) \
.applymap(highlight_5, subset=pd.IndexSlice[:, ['f5_non_e12','f5_non_e1','f5_non_e2','f5_non_e3','f5_non_e4','f5_non_e5','f5_non_e6',\
'f5_non_e7','f5_non_e8','f5_non_e9','f5_non_e10','f5_non_e11','f_non_e12','f_non_e8','f_non_e9','B_non_E','f_non_e1','f_non_e2','f_non_e11',\
'f_non_e3','f_non_e4','f_non_e5','f6_non_e7','f_non_e10','f_non_e13','f_non_e14','f_non_e15','f_non_e16','f_non_e17','f_non_e18']])
print(df_final_1)
df_final_1.to_excel("noise_reference.xlsx", index=False)

df_final_2 = df_final[['date','plate','bot_id','LC_A','HC_A','Intact_A','LC_B','HC_B','Intact_B','LC_E','HC_E','Intact_E',\
'LC_F','HC_F','LC_F5','HC_F5','Intact_F']]
df_final_2 = df_final_2.reset_index(drop=True).style.applymap(highlight_1, subset=pd.IndexSlice[:, ['LC_A','HC_A','Intact_A']]) \
.applymap(highlight_2, subset=pd.IndexSlice[:, ['LC_B', 'HC_B','Intact_B']]) \
.applymap(highlight_3, subset=pd.IndexSlice[:, ['LC_E','HC_E','Intact_E']]) \
.applymap(highlight_4, subset=pd.IndexSlice[:, ['LC_F','HC_F','LC_F5','HC_F5','Intact_F']])
print(df_final_2)
df_final_2.to_excel("endopep_peak_list.xlsx", index=False)
